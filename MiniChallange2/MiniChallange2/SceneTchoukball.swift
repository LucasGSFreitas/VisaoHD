...
class SceneTchoukball: UIViewController {
    ...
    func playBall()
    {
        ...
        transladeAndScaleTransform = CATransform3DTranslate(transladeAndScaleTransform, -70, -40, 0)
        rotateBallImage(transladeAndScaleTransform)
        self.imageBall4.layer.zPosition = 2
        
        transladeAndScaleTransform = CATransform3DTranslate(transladeAndScaleTransform, -20, 10, 0)
        rotateBallImage(transladeAndScaleTransform)
...
//        rotateBallImage(transladeAndScaleTransform)
        ...
        transladeAndScaleTransform = CATransform3DScale(transladeAndScaleTransform, 0.9, 0.9, 1)
    ...
    func ballPlayed()
    {
        ...
        transladeAndScaleTransform = CATransform3DTranslate(transladeAndScaleTransform, -5, 280, 0)
        rotateBallImageFar(transladeAndScaleTransform)
        self.imageBall4.layer.zPosition = 2
        
        transladeAndScaleTransform = CATransform3DTranslate(transladeAndScaleTransform, -2, 10, 0)
        rotateBallImageFar(transladeAndScaleTransform)
    ...
    func rotateBallImageFar(transform:CATransform3D) {
